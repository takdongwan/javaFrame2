...
public class MusicGame extends JFrame {
	...
	public MusicGame() {
		...
		hardButton.setVisible(false);//맨처음엔 보이지 않다가 .시작하기버튼 누르고 메인화면 넘어왔을때 메인스크린에 들어와서 보이기시작함.
	...
	public void gameStart(int nowSelectedm, String difficulty) {
		if(selectedMusic != null) {
			selectedMusic.close();
			isMainScreen = false;
