...
public class MusicGame extends JFrame {
	...
	public MusicGame() {
		...
		addKeyListener(new KeyListener());// 방금만든 클래스가 이코드를 사용해서 적용됨.
		...
		easyButton.setVisible(false);//맨처음엔 보이지 않다가 .시작하기버튼 누르고 메인화면 넘어왔을때 메인스크린에 들어와서 보이기시작함.
		...
		hardButton.setVisible(false);//맨처음엔 보이지 않다가 .시작하기버튼 누르고 메 인화면 넘어왔을때 메인스크린에 들어와서 보이기시작함.
		...
		backButton.setVisible(false);//맨처음엔 보이지 않다가 .시작하기버튼 누르고 메인화면 넘어왔을때 메인스크린에 들어와서 보이기시작함.
